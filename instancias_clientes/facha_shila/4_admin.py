...
with tab_retro:
    ...
    with st.form("form_retroactivo"):
        ...
        vendedor = col_vend.selectbox("¿Quién vendió?", ["Dueño", "Vendedor 1", "Vendedor 2"]) # Ajusta estos nombres
...
# ==============================================================================
# TAB 2: ELIMINAR PRODUCTO (Corregido KeyError)
# ==============================================================================
with tab_producto:
